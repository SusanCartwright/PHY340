...
2. Consult review articles, preferably more than one, and preferably by different authors.  Review articles *should* provide a balanced view of the field at the time of writing.  If three review articles all paint much the same picture, then you have a clear view of the state of play, and can fit more recent articles into context.
